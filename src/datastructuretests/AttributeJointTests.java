...
public class AttributeJointTests {
	...
	public void constructorArray() {
		...
		Vector<Attribute> getterJoint = arrayConstructor.getAttributeJoint();
		assertEquals(attrArray.length, getterJoint.size());
		for (int i = 0; i < attrArray.length; i++)
			assertEquals(attrArray[i], getterJoint.elementAt(i).getAttribute());
	}
	
	@Test
	public void constructorVector() {
		Vector<Attribute> attrVector = new Vector<Attribute>();
		attrVector.addElement(new Attribute("A"));
		attrVector.addElement(new Attribute("B"));
		
		AttributeJoint vectorConstructor = new AttributeJoint(attrVector);
		Vector<Attribute> getterJoint = vectorConstructor.getAttributeJoint();
		assertEquals(attrVector.size(), getterJoint.size());
		for (int i = 0; i < getterJoint.size(); i++)
			assertEquals(attrVector.elementAt(i).getAttribute(), getterJoint.elementAt(i).getAttribute());	
	}
	...
	public void toStringAttributeJointSizeZero() {
		Vector<Attribute> attrJointVector = new Vector<>();
	...
	public void sortContructor() {
		...
		Vector<Attribute> unsortedVector_B = new Vector<Attribute>();
		unsortedVector_B.addElement(new Attribute("C"));
		unsortedVector_B.addElement(new Attribute("B"));
		unsortedVector_B.addElement(new Attribute("A"));
	...
	public void isKeyResult_0_ABCRelationFive() {
		assertEquals(0, this.mainAttributeJoint.isKey(this.setUpObject.relationFive()));
	}
	
	@Test
	public void isKeyResult_1_ARelationFive() {
		AttributeJoint attrJoint = this.setUpObject.attributeJoint_A();
		assertEquals(1, attrJoint.isKey(this.setUpObject.relationFive()));
	}
	
	@Test
	public void isKeyResult_neg1_ARelationFive() {
		AttributeJoint attrJoint = this.setUpObject.attributeJoint_C();
		assertEquals(-1, attrJoint.isKey(this.setUpObject.relationFive()));
	}
	...
	public void isPartOfTrue_AB_in_AB() {
		AttributeJoint attrJoint = this.setUpObject.attributeJoint_AB(); 
	...
	public void containsJointsFromTrue_ABCD_From_CD_CE_CF_ABD_ABE_ABF() {
		AttributeJoint attrJoint = this.setUpObject.attributeJoint_ABCD();
	...
	public void containsJointsFromFalse_B_From_A() {
		AttributeJoint attrJoint = this.setUpObject.attributeJoint_B();
	...
	public void intersectAFromAB() {
		AttributeJoint expected = this.setUpObject.attributeJoint_A();
		AttributeJoint firstJoined = this.setUpObject.attributeJoint_AB();
		AttributeJoint secondJoined = this.setUpObject.attributeJoint_A();
	...
	public void intersectNullFromA() {
		...
		AttributeJoint firstJoined = this.setUpObject.attributeJoint_A();
	...
	public void intersectDromABCDEandDF() {
		AttributeJoint expected = this.setUpObject.attributeJoint_D();
		AttributeJoint firstJoined = this.setUpObject.attributeJoint_ABCDE();
		AttributeJoint secondJoined = this.setUpObject.attributeJoint_DF();
		assertEquals(expected, firstJoined.intersect(secondJoined));
	}
	...
	public void substracABFromABC() {
		AttributeJoint expected = this.setUpObject.attributeJoint_C();
		AttributeJoint firstJoined = this.setUpObject.attributeJoint_ABC();
		AttributeJoint secondJoined = this.setUpObject.attributeJoint_AB();
		assertEquals(expected, firstJoined.substract(secondJoined));
	}
	
	@Test
	public void substracBCFromADE() {
		AttributeJoint expected = this.setUpObject.attributeJoint_ADE();
		AttributeJoint firstJoined = this.setUpObject.attributeJoint_ADE();
		AttributeJoint secondJoined = this.setUpObject.attributeJoint_BC();
		assertEquals(expected, firstJoined.substract(secondJoined));
	}
	...
	public void isNullAttributeJointAB() {
		assertFalse(this.setUpObject.attributeJoint_AB().isNull());
	}
	*/
}